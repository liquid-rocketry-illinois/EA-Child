...
class SDCard{
    ...
    void SDWriteData(Vector3D* MainIMUpyr, Vector3D* SecIMUpyr, Vector3D* Magnetometer, float Temperature, float Pressure, float Humidity){ // Function to write string to SD card file. FOLLOW INPUTS FOR FORMAT!!
